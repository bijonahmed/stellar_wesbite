...
export default function PropertyDevelopmentPage() {
  ...
  useEffect(() => {
    fetch(`${process.env.NEXT_PUBLIC_API_BASE}/public/getsPost?slug=property-development`)
      .then((res) => res.json())
      .then((data) => {
  ...
  return (
    <>
      ...
      <PageHeader
        ...
        subtitle="Explore our premium property developments bringing quality living spaces to Dhaka's most prestigious addresses."
        breadcrumbs={[{ label: "Property Development" }]}
      />
        ...
        <div className="container">
          ...
          <div className="row">
            {loading ? (
              ...
              <p style={{ color: "#999", textAlign: "center", width: "100%" }}>No property development projects found.</p>
            )}
          </div>
        </div>
      </section>
