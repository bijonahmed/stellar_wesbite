...
export default function UserAddPage() {
  ...
  const title = "Roles Add"; //pathname ? pathname.replace("/", "").charAt(0).toUpperCase() + pathname.slice(2) : "";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE}/roles/create`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  if (!permissions.includes("create role")) {
